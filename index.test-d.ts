...
import { TypeOf, Schema } from './src/types';
...
declare const str2: TypeOf<Schema<string, { optional: true }, never>>;
expectType<string | undefined>(str2);

declare const str3: TypeOf<Schema<string, { optional: true }, 'a'>>;
expectType<'a' | undefined>(str3);

declare const str4: TypeOf<Schema<string, {}, 'a'>>;
expectType<'a'>(str4);

declare const str5: TypeOf<Schema<string, { nullable: true }, never>>;
expectType<string | null>(str5);

declare const str6: TypeOf<Schema<string, { nullable: true }, 'a'>>;
expectType<'a' | null>(str6);

declare const str7: TypeOf<Schema<string, { optional: true; nullable: true }, 'a'>>;
expectType<'a' | null | undefined>(str7);

declare const str8: TypeOf<Schema<string, { optional: true; nullable: true }, never>>;
